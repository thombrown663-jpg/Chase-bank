...
const USERS = {
  ...
  'RolandC_408': {
    ...
    address: '2811 Marietta Ave, Lancaster, PA 17601',
    memberSince: 'January 2022',
    checking: { balance: 36847.53, number: '7702', routing: '021000021' },
    savings:  { balance: 13920.44,  number: '3351', routing: '021000021' },
    total: 50767.97,
    creditCard: {
      last4: '5531', type: 'Mastercard Platinum',
      network: 'Mastercard',
      limit: 8000, balance: 412.38, available: 7587.62,
      dueDate: 'Apr 18, 2026', minPayment: 25.00
    },
    investments: [
      { ticker: 'SPY',  name: 'SPDR S&P 500 ETF',     shares: 10, price: 521.34, change: +3.10, pct: +0.60, value: 5213.40 },
    ...
    transactions: [
      { icon:'dep', emoji:'💵', name:'Salary Deposit',         detail:'Direct Deposit',        date:'Mar 31, 2026 · 8:00 AM',  amount:'+$2,950.00', pos:true,  status:'Completed' },
      { icon:'wd',  emoji:'🛒', name:'Grocery Purchase',       detail:'Walmart Supercenter',   date:'Mar 29, 2026 · 5:22 PM',  amount:'−$63.14',    pos:false, status:'Completed' },
      { icon:'bl',  emoji:'⚡', name:'Electric Bill',          detail:'Duke Energy',           date:'Mar 27, 2026 · 9:00 AM',  amount:'−$98.50',    pos:false, status:'Completed' },
      { icon:'tr',  emoji:'🔄', name:'Transfer to Savings',    detail:'Chase ••3351',          date:'Mar 25, 2026 · 12:10 PM', amount:'−$300.00',   pos:false, status:'Completed' },
      { icon:'zl',  emoji:'⚡', name:'Zelle® Received',        detail:'From Kevin R.',         date:'Mar 22, 2026 · 3:44 PM',  amount:'+$175.00',   pos:true,  status:'Completed' },
      { icon:'wd',  emoji:'⛽', name:'Gas Station',            detail:'Shell #4412',           date:'Mar 20, 2026 · 7:55 AM',  amount:'−$54.80',    pos:false, status:'Completed' },
      { icon:'bl',  emoji:'📱', name:'Phone Bill',             detail:'AT&T Wireless',         date:'Mar 17, 2026 · 8:00 AM',  amount:'−$85.00',    pos:false, status:'Completed' },
      { icon:'wd',  emoji:'🍽️', name:'Restaurant',             detail:'Olive Garden',          date:'Mar 14, 2026 · 7:30 PM',  amount:'−$47.20',    pos:false, status:'Completed' },
      { icon:'dep', emoji:'💵', name:'Tax Refund',             detail:'IRS Direct Deposit',    date:'Mar 10, 2026 · 10:15 AM', amount:'+$980.00',   pos:true,  status:'Completed' },
      { icon:'atm', emoji:'🏧', name:'ATM Withdrawal',         detail:'Chase ATM #07702',      date:'Mar 7, 2026 · 2:00 PM',   amount:'−$200.00',   pos:false, status:'Completed' },
    ]
  }
};
